          ...
          <tr>
            ...
            <th className="tooltip-container col-center">
              ...
              <span className="tooltip-text">
                User's score after cancellation
              </span>
            </th>
        ...
        <tbody>
          {data.map((c) => (
            <tr
              ...
              className={c.is_bad ? "row-bad" : "row-good"}
            >
              <td className="td-user">{c.name}</td>
              <td className="td-time">
                {formatTimestamp(c.cancellation_time)}
              </td>
              <td className="col-center">{c.possible_new_score}</td>
              <td className="col-center">
                <span
                  className={`lc-badge ${
                    c.is_bad ? "badge-danger" : "badge-success"
                  }`}
                >
                  {c.is_bad ? "Bad" : "Good"}
                </span>
